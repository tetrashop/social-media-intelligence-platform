...
// ---------- داده‌های آموزشی پیشرفته (تمپلیت‌های دانشمندان علوم) ----------
const trainingData = [
  // Greetings
  { text: 'سلام', intent: 'greeting' },
  { text: 'hello', intent: 'greeting' },
  { text: 'درود', intent: 'greeting' },
  { text: 'سلام رفیق', intent: 'greeting' },
  { text: 'خوبی؟', intent: 'greeting' },
  { text: 'چطوری؟', intent: 'greeting' },
  { text: 'صبح بخیر', intent: 'greeting' },
  { text: 'عصر بخیر', intent: 'greeting' },

  // Farewells
  { text: 'خداحافظ', intent: 'farewell' },
  { text: 'bye', intent: 'farewell' },
  { text: 'goodbye', intent: 'farewell' },
  { text: 'می‌بینمت', intent: 'farewell' },
  { text: 'تا بعد', intent: 'farewell' },
  { text: 'شب خوش', intent: 'farewell' },

  // Thanks
  { text: 'ممنون', intent: 'thanks' },
  { text: 'مرسی', intent: 'thanks' },
  { text: 'thanks', intent: 'thanks' },
  { text: 'thank you', intent: 'thanks' },
  { text: 'سپاسگزارم', intent: 'thanks' },
  { text: 'دستت درد نکنه', intent: 'thanks' },

  // Help
  { text: 'کمک', intent: 'help' },
  { text: 'help', intent: 'help' },
  { text: 'راهنما', intent: 'help' },
  { text: 'چیکار می‌تونی بکنی؟', intent: 'help' },
  { text: 'چه امکاناتی داری؟', intent: 'help' },
  ...
  { text: 'درباره تو', intent: 'about' },
  { text: 'خودت رو معرفی کن', intent: 'about' },
  { text: 'اسمت چیه', intent: 'about' },

  // Analysis
  { text: 'تحلیل کن', intent: 'analysis' },
  { text: 'analyz', intent: 'analysis' },
  { text: 'بررسی کن', intent: 'analysis' },
  { text: 'این جمله رو تحلیل کن', intent: 'analysis' },
  { text: 'احساس من چیه؟', intent: 'analysis' },
  { text: 'شخصیت من چطوره؟', intent: 'analysis' },

  // General (جملات عمومی)
  { text: 'چطوری', intent: 'general' },
  { text: 'امروز چطور گذشت', intent: 'general' },
  { text: 'یه چیز جالب بگو', intent: 'general' },
  { text: 'هوا چطوره', intent: 'general' },
  { text: 'دوست دارم موزیک گوش بدم', intent: 'general' },
  { text: 'I like music', intent: 'general' },
  { text: 'today was a great day', intent: 'general' }
];
...
trainingData.forEach((item, index) => {
  ...
  if ((index + 1) % 10 === 0) {
    console.log(`✓ ${index + 1}/${trainingData.length} نمونه آموزش داده شد`);
  }
});
...
console.log(`✅ مدل با موفقیت در ${MODEL_PATH} ذخیره شد.`);
console.log('📦 حالا می‌توانید این فایل را به گیت اضافه کنید و روی Vercel فقط بارگذاری شود.');
