...
export default {
    async fetch(request, env, ctx) {
            ...
            return new Response(`
                ...
                <body>
                    <div class="container">
                        ...
                        <p>استقرار مستقیم - بدون Build خودکار</p>
                        ...
                        <div style="background: #f8f9fa; padding: 20px; border-radius: 10px;">
                            <p><strong>پست:</strong> ۱۲۷ | <strong>ورژن:</strong> ۸.۰.۰</p>
        ...
        // اضافه کردن این بخش به src/index.js در قسمت مسیریابی
    ...
    <div class="container">
        <div class="card">
            ...
            <div style="margin-top: 30px; padding: 20px; background: #e7f3ff; border-radius: 10px;">
                <h4>🎯 نحوه استفاده</h4>
                <p>برای تست سیستم تحلیل، به صفحه <a href="/chat" style="color: #007bff;">چت هوشمند</a> مراجعه کنید و پیام خود را ارسال نمایید.</p>
            </div>
        </div>
    </div>
</body>
